...
# ========== 配置 ==========
INSTALL_DIR="/www/wwwroot/post-to-wechat"
...
EOF
  ...
  echo -e "${YELLOW}  server_publish_url: https://<你的域名>${NC}"
...
echo ""
echo "本地中转服务已启动：http://127.0.0.1:$PORT"
echo ""
echo -e "${YELLOW}【还需手动完成的 2 件事】${NC}"
echo ""
echo "1. 微信公众号 IP 白名单："
...
echo "     发送域名: \$host"
echo ""
echo -e "${YELLOW}【客户端配置 ~/.post-to-wechat/EXTEND.md】${NC}"
echo "   default_publish_method: server-api"
echo "   server_publish_url: https://<你的域名>"
